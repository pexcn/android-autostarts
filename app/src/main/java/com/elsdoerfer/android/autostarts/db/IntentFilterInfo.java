...
public class IntentFilterInfo implements Parcelable {
    ...
    public IntentFilterInfo(ComponentInfo componentInfo, String action, int priority) {
    ...
    public static final Parcelable.Creator<IntentFilterInfo> CREATOR = new Parcelable.Creator<IntentFilterInfo>() {
